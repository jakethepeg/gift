...
import org.apache.commons.beanutils.Converter;
 ...
 /**
   ...
   * @version $Revision: 1.1.1.1 $ $Date: 2009/06/05 06:13:50 $
   * @since 1.3
   */
 
 public final class UtilTimeConverter implements Converter {
     ...
     /**
       ...
       */
     public UtilTimeConverter(Object defaultValue) {
     ...
     public Object convert(Class type, Object value) {
         ...
         try {
             return ((java.util.Date) java.sql.Date.valueOf(value.toString()));
         } catch (Exception e) {
             if (useDefault) {
                 return (defaultValue);
             } else {
